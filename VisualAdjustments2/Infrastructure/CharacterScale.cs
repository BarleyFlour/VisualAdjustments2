...
namespace VisualAdjustments2.Infrastructure
{
    ...
    {
        [HarmonyPatch(typeof(UnitEntityView), nameof(UnitEntityView.GetSizeScale), argumentTypes: new Type[]{typeof(Size)} ) ]
    ...
    public class CharacterScale2
    {
        [HarmonyPatch(typeof(UnitEntityView), nameof(UnitEntityView.GetSizeScale), argumentTypes: new Type[]{} ) ]
        private static class UnitEntityView_GetSizeScale2_Patch
        {
            private static void Postfix(UnitEntityView __instance, ref float __result)
            {
                try
