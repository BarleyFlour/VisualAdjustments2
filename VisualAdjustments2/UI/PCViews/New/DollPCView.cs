...
namespace VisualAdjustments2.UI
{
    public class DollPCView : ViewBase<DollVM>
    {
        ...
        {
            base.AddDisposable(base.ViewModel.m_DollAppearanceVM.Subscribe((CharGenAppearancePhaseVMModified val) =>
            {
                this.m_CharGenAppearancePCView.Bind(val);
            }));
            base.AddDisposable(
                base.ViewModel.createDollVM.Subscribe(new Action<CreateDollVM>(this.m_CreateDollPCView.Bind)));
