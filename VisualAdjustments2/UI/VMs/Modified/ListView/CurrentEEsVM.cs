...
{
    public class CurrentEEsVM : SelectionGroupVM<ListViewItemVM>
    {
        public CurrentEEsVM(ReactiveCollection<ListViewItemVM> entitiesCollection, ReactiveProperty<ListViewItemVM> entity) : base(entitiesCollection)
        {
