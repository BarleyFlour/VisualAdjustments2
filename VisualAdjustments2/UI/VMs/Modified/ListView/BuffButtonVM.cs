...
namespace VisualAdjustments2.UI
{
    ...
    public class BuffButtonVM : SelectionGroupEntityVM
    {
        public BuffButtonVM(BlueprintUnitFact feature, bool AddOrRemove, Action<BuffButtonVM> act) : base(true)
        {
            ...
            //if (fxblocker.AllAbilityGUIDs.Count > 1) this.FeatureDescription = fxblocker.FullNameMerged;
            if (!fxblocker.FullNameMerged.IsNullOrEmpty()) this.FeatureDescription = fxblocker.FullNameMerged;
